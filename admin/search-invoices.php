...
if (strlen($_SESSION['barberia_mejorada']==0)) {
...
<html>
<head>
<title>THE_KING_BARBERSHOP | Buscar Cotizaciones</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Buscar Cotizacion</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Buscar Cotizaciones:</h4>
						<div class="form-body">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Buscar por Número de Cotizacion o Número de Producto</label> <input id="searchdata" type="text" name="searchdata" required="true" class="form-control">
