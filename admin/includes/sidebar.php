  <div class=" sidebar" role="navigation">
          ...
          <ul class="nav" id="side-menu">
            ...
            <li>
             ...
             <li>
              ...
              <ul class="nav nav-second-level collapse">
                 <li><a href="bwdates-reports-ds.php"> Cotizaciones por Fecha</a></li>
    ...
    <li>
              <a href="invoices.php" class="chart-nav"><i class="fa fa-file-text-o nav_icon"></i>Cotizaciones</a>
            </li>
            <li>
              <a href="search-appointment.php" class="chart-nav"><i class="fa fa-search nav_icon"></i>Buscar Citas</a>
            </li>
            <li>
              <a href="search-invoices.php" class="chart-nav"><i class="fa fa-search nav_icon"></i>Buscar Cotizacion</a>
            </li>
