...
<html lang="es">
  <head>
    <title>THE_KING_BARBERSHOP-Contacto</title>
...
?>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="https://www.google.com/maps/dir//10.3865839,-75.4932941/@10.3865628,-75.4932633,21z?entry=ttu&g_ep=EgoyMDI0MTAyMy4wIKXMDSoASAFQAw%3D%3D"> <?php  echo $row['PageDescription'];?></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="https://wa.me/573205270675?text=quiero%hacer%una%consulta"> +<?php  echo $row['MobileNumber'];?></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
