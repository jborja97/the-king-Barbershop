...
<html lang="es">
  <head>
    <title>THE_KING_BARBERSHOP-GRACIAS</title>
...
<?php
$numeroCita = $_SESSION['aptno'];
$numeroTelefono = "573205270675"; // Reemplaza este número con el número de WhatsApp de la barbería.
$mensaje = "He realizado una cita. Con número:".$numeroCita;
$urlWhatsApp = "https://wa.me/$numeroTelefono?text=".urlencode($mensaje);
?>

<p>
    <a href="<?php echo $urlWhatsApp; ?>" target="_blank">
        <img src="images/imagen_whatsap.png" alt="WhatsApp" style="width: 80px; height: 80px;">
    </a>
</p>

<p style="text-align: center; font-weight: bold;">¿Tienes dudas? Haz clic en el logo de WhatsApp para comunicarte con nosotros y confirmar tu cita.</p>
        </div>
    	</div>
